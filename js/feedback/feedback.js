...
(function($){
    ...
    var settings = $.extend({
			...
			tpl: {
				description:	'<div id="feedback-welcome"><div class="feedback-logo">Zgłoszenie</div><p>Zgłoszenia pozwalają przesłać nam sugestie odnośnie naszych produktów, umożliwiają również szybszą reakcję na awarie.Czekamy na raporty dotyczące problemów , pomysłów i ogólne uwagi .</p><p>Rozpocznij od uzupełnienia pola opisu:</p><textarea id="feedback-note-tmp"></textarea><p>Następnie zostanie zidentyfikowany obszar strony związanej z danym opisem.</p><button id="feedback-welcome-next" class="feedback-next-btn feedback-btn-gray">Dalej</button><div id="feedback-welcome-error">Proszę podać opis zgłoszenia:</div><div class="feedback-wizard-close"></div></div>',
				highlighter:	'<div id="feedback-highlighter"><div class="feedback-logo">Zgłoszenie</div><p>Kliknij i przeciągnij na stronę aby zaznaczyć lub zamazać jej częśc , pomoże nam to lepiej zrozumieć twoje zgłoszenie.</p><button class="feedback-sethighlight feedback-active"><div class="ico"></div><span>Zaznacz</span></button><label>Zaznacz obszar związany z twoim zgłoszeniem.</label><button class="feedback-setblackout"><div class="ico"></div><span>Zamaż</span></button><label class="lower">Zamaż część strony której nie chcesz ujawniać</label><div class="feedback-buttons"><button id="feedback-highlighter-next" class="feedback-next-btn feedback-btn-gray">Dalej</button><button id="feedback-highlighter-back" class="feedback-back-btn feedback-btn-gray">Powrót</button></div><div class="feedback-wizard-close"></div></div>',
				overview:		'<div id="feedback-overview"><div class="feedback-logo">Zgłoszenie</div><div id="feedback-overview-description"><div id="feedback-overview-description-text"><h3>Opis zgłoszenia</h3><h3 class="feedback-additional">Dodatkowe informacje</h3><div id="feedback-additional-none"><span>Brak</span></div><div id="feedback-browser-info"><span>Informacje o przeglądarce internetowej</span></div><div id="feedback-page-info"><span>Informacje o stronie</span></div><div id="feedback-page-structure"><span>Struktura strony</span></div></div></div><div id="feedback-overview-screenshot"><h3>Screenshot</h3></div><div class="feedback-buttons"><button id="feedback-submit" class="feedback-submit-btn feedback-btn-blue">Wyślij</button><button id="feedback-overview-back" class="feedback-back-btn feedback-btn-gray">Powrót</button></div><div id="feedback-overview-error">Proszę wprowadzić opis zgłoszenia.</div><div class="feedback-wizard-close"></div></div>',
				submitSuccess:	'<div id="feedback-submit-success"><div class="feedback-logo">Zgłoszenie</div><p>Dziękujemy za twoje zgłoszenie,doceniamy każdą informację która została nam przesłana.</p><p>Niestety nie możemy reagować na każde zgłoszenie indywidualnie, ale na pewno użyjemy twojego komentarza aby poprawić nasz system.</p><button class="feedback-close-btn feedback-btn-blue">OK</button><div class="feedback-wizard-close"></div></div>',
				submitError:	'<div id="feedback-submit-error"><div class="feedback-logo">Zgłoszenie</div><p>Niestety, złośliwość rzeczy martwych, ale nie udało się wysłać twojego zgłoszenia.Prosimy spróbuj później.</p><button class="feedback-close-btn feedback-btn-blue">OK</button><div class="feedback-wizard-close"></div></div>'
			},
			onClose: 				function() {},
